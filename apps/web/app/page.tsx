...
export default function Page () {
    ...
    return (
      <div className={classes['application']}>
        ...
        <div>
            <input onChange={(e) => setMessage(e.target.value)} value={message} className={classes['chat-input']} />
            <button type={"button"} onClick={() => {sendMessage(message); setMessage('')}} className={classes['button']}>Send</button>
        </div>
      </div>
    )
}
